...
const Header = React.memo(({ query, setQuery, type, setType }: HeaderProps) => {
                ...
                <div className={styles.filterConatiner} style={scaleStyle}>
                        ...
                        <div className={styles.filterDiv}>
                            <input
                                ...
                                style={{ display: "none" }}
                            />
                            <button onClick={() => { setType('water') }}>
                                <img src={water} alt="Water" />
                            </button>
                            <button onClick={() => { setType('steel') }}>
                                <img src={steel} alt="Steel" />
                            </button>
                            <button onClick={() => { setType('rock') }}>
                                <img src={rock} alt="Rock" />
                            </button>
                            <button onClick={() => { setType('psychic') }}>
                                <img src={psychic} alt="Psychic" />
                            </button>
                            <button onClick={() => { setType('poison') }}>
                                <img src={poison} alt="Poison" />
                            </button>
                            <button onClick={() => { setType('normal') }}>
                                <img src={normal} alt="Normal" />
                            </button>
                            <button onClick={() => { setType('ice') }}>
                                <img src={ice} alt="Ice" />
                            </button>
                            <button onClick={() => { setType('ground') }}>
                                <img src={ground} alt="Ground" />
                            </button>
                            <button onClick={() => { setType('grass') }}>
                                <img src={grass} alt="Grass" />
                            </button>
                            <button onClick={() => { setType('ghost') }}>
                                <img src={ghost} alt="Ghost" />
                            </button>
                            <button onClick={() => { setType('flying') }}>
                                <img src={flying} alt="Flying" />
                            </button>
                            <button onClick={() => { setType('fire') }}>
                                <img src={fire} alt="Fire" />
                            </button>
                            <button onClick={() => { setType('fighting') }}>
                                <img src={fighting} alt="Fighting" />
                            </button>
                            <button onClick={() => { setType('electric') }}>
                                <img src={electric} alt="Electric" />
                            </button>
                            <button onClick={() => { setType('fairy') }}>
                                <img src={fairy} alt="Fairy" />
                            </button>
                            <button onClick={() => { setType('dragon') }}>
                                <img src={dragon} alt="Dragon" />
                            </button>
                            <button onClick={() => { setType('dark') }}>
